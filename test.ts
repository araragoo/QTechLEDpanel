...
//        showRainbow(startHue: number = 1, endHue: number = 360) {
        function showRainbow(startHue: number = 1, endHue: number = 360) {
...
//        setPixelColor(pixeloffset: number, rgb: number): void {
        function setPixelColor(pixeloffset: number, rgb: number): void {
...
//        setMatrixWidth(width: number) {
        function setMatrixWidth(width: number) {
...
//        setMatrixColor(x: number, y: number, rgb: number) {
        function setMatrixColor(x: number, y: number, rgb: number) {
...
//        shift(offset: number = 1): void {
        function shift(offset: number = 1): void {
                offset = offset >> 0;
            const stride = this._mode === NeoPixelMode.RGBW ? 4 : 3;
...
//        rotate(offset: number = 1): void {
        function rotate(offset: number = 1): void {
            offset = offset >> 0;
            const stride = this._mode === NeoPixelMode.RGBW ? 4 : 3;
